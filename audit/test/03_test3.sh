...
solc_0.4.16 --version | tee -a $TEST3OUTPUT
...
var airdrop1_1Tx = token.claimAirdrop({from: account4, gas: 100000});
var airdrop1_2Tx = token.claimAirdrop({from: account5, gas: 100000});
var airdrop1_3Tx = token.claimAirdrop({from: account6, gas: 100000});
var airdrop1_4Tx = token.adminClaimAirdrop(account7, {from: adminWallet, gas: 100000});
while (txpool.status.pending > 0) {
}
printTxData("airdrop1_1Tx", airdrop1_1Tx);
printTxData("airdrop1_2Tx", airdrop1_2Tx);
printTxData("airdrop1_3Tx", airdrop1_3Tx);
printTxData("airdrop1_4Tx", airdrop1_4Tx);
printBalances();
failIfTxStatusError(airdrop1_1Tx, airdropMessage + " - ac4");
failIfTxStatusError(airdrop1_2Tx, airdropMessage + " - ac5");
failIfTxStatusError(airdrop1_3Tx, airdropMessage + " - ac6");
failIfTxStatusError(airdrop1_4Tx, airdropMessage + " - ac7 by admin");
printTokenContractDetails();
console.log("RESULT: ");
